...
const MoveList: React.FC<{ moves: Move[] }> = ({ moves }) => {
	...
	return (
		<div className="relative glassy_bg flex flex-col h-[35vh] md:h-full p-3 flex-1  overflow-y-scroll overflow-x-hidden scrolling-touch scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2">
			{moveStrings
				.reverse()
